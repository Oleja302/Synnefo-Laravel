<template>
    <div id="areaFile" class="area d-flex justify-content-center align-items-center">
        ...
        <svg v-if="icoFile" @click="postFiles()" class="ico" width="90" height="90" viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
            id="mdi-file-upload">
            <path style="fill: #3E5F8A;"
    ...
    <div id="areaFolder" class="area d-flex justify-content-center align-items-center">
        ...
        <svg v-if="icoFolder" @click="postFolder()" class="ico" width="100" height="100" viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
